      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-text-muted mb-10">
            ...
            <span className="text-text-primary font-medium">Hall Booking</span>
          </div>

          <SectionHeading
            title="Available Halls"
            subtitle="Each hall is maintained with traditional values and modern amenities to make your event memorable."
          />
