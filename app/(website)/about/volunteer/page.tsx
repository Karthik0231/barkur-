...
import { TEMPLE_EMAIL, TEMPLE_PHONE } from "@/lib/constants"
...
export default function VolunteerPage() {
  ...
  return (
    <div className="min-h-screen">
      <PageBanner
        title={t("pages.aboutVolunteer.title")}
        subtitle={t("pages.aboutVolunteer.subtitle")}
        eyebrow={t("pages.aboutVolunteer.eyebrow")}
      />
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-text-muted mb-12">
            ...
            <ChevronRight className="h-3.5 w-3.5" />
            <span className="text-text-primary font-medium">{t("nav.volunteer")}</span>
          </div>

          <AnimatedSection>
            <SectionHeading
              title={t("sections.aboutVolunteerS1Title")}
              subtitle={t("sections.aboutVolunteerS1Sub")}
            />
          </AnimatedSection>
            ...
            <div className="lg:col-span-2">
              <AnimatedSection>
                <h2 className="text-3xl md:text-4xl font-heading font-bold text-primary leading-tight">
                  {t("sections.aboutVolunteerRegisterTitle")}
                </h2>
                <p className="text-text-secondary mt-4 leading-relaxed">
                  {t("sections.aboutVolunteerRegisterDesc")}
                </p>
              ...
              <AnimatedSection delay={0.15}>
                {submitted ? (
                  <Card variant="elevated" className="p-8 lg:p-12 text-center">
                    ...
                    <h3 className="text-2xl font-heading font-bold text-primary">{t("sections.aboutVolunteerThankYouTitle")}</h3>
                    <p className="text-text-secondary mt-2">{t("sections.aboutVolunteerThankYouDesc")}</p>
